...
<%
    // Database connection
    String jdbcURL = "jdbc:mysql://localhost:3306/bookstore"; // Change to your DB name
    ...
    try {
        ...
        // Count pending bills (example: where status = 'Pending')
        PreparedStatement ps4 = conn.prepareStatement("SELECT COUNT(*) FROM bill WHERE status='Pending'");
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="stats-container">
            ...
            <div class="stat-card">Pending Bills<br><%= pendingBills %></div>
        </div>
    </div>
